...
namespace Client
{
    public partial class HoraFecha : Form
    {
        ...
        public void setrespuesta(string a, string dia, string mes, string ano, string hora)
        {
            string mensaje = string.Empty;

            if (a == "3/NoExist")
            {
                mensaje = "La partida con el ID: " + IDpartida.Text + " no existe.";
            }
            else
            {
                mensaje = "La partida fue jugada en la fecha " + dia + "/" + mes + "/" + ano + " - " + hora + ".";
            }
